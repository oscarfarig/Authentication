...
public class MainActivity extends AppCompatActivity{
    ...
    public void inicializarControlesAuth(){
        ...
        btnRegistrar=findViewById(R.id.btnRegistrarnuevo);
    ...
    private void irHome(FirebaseUser user) {
        seleccionado=spPerfil.getSelectedItem().toString();
        Toast.makeText(getApplicationContext()," estas en:"+seleccionado,Toast.LENGTH_LONG).show();
        if (user != null) {
    ...
    private void setAdapterSpinner(){
        ...
        ArrayAdapter<String> adapter = new
                ArrayAdapter<String>(this, com.facebook.R.layout.support_simple_spinner_dropdown_item,
                opciones);
